...
with tf.Session() as sess:
    ...
    Xp_r, Xp_i = sess.run([Xp_r,Xp_i], feed_dict=feed_dict_test)
    ...
    G1 = sess.run('BS_operations/dense_5/kernel:0', feed_dict=feed_dict_test)
    c1 = sess.run('BS_operations/dense_5/bias:0', feed_dict=feed_dict_test)
    G2 = sess.run('BS_operations/dense_6/kernel:0', feed_dict=feed_dict_test)
    c2 = sess.run('BS_operations/dense_6/bias:0', feed_dict=feed_dict_test)
    G3 = sess.run('BS_operations/dense_7/kernel:0', feed_dict=feed_dict_test)
    c3 = sess.run('BS_operations/dense_7/bias:0', feed_dict=feed_dict_test)
    G4 = sess.run('BS_operations/dense_8/kernel:0', feed_dict=feed_dict_test)
    c4 = sess.run('BS_operations/dense_8/bias:0', feed_dict=feed_dict_test)
    sio.savemat('Data_K1_weight_bias.mat',dict(A1=A1,A2=A2,A3=A3,A4=A4,\
                                            b1=b1,b2=b2,b3=b3,b4=b4,\
                                            Xp_r=Xp_r,Xp_i=Xp_i,\
                                            G1=G1,G2=G2,G3=G3,G4=G4,\
                                            c1=c1,c2=c2,c3=c3,c4=c4))           
    loss_test_Final,hhat = sess.run([loss,hhat], feed_dict=feed_dict_test_Final)
